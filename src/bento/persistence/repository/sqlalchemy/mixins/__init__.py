"""Repository Mixins for enhanced functionality.

This package provides modular mixins that can be composed to add
various repository capabilities:
...
Future:
- TransactionLockMixin, RelationLoadingMixin (if needed)
"""

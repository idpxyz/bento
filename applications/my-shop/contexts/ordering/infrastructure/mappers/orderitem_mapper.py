...
class IOrderItemMapper(Protocol):
    """OrderItem 映射器协议
    ...
    def to_po(self, domain_obj: OrderItem) -> OrderItemPO:
        """领域对象 -> 持久化对象"""
        ...

    def to_domain(self, po: OrderItemPO) -> OrderItem:
        """持久化对象 -> 领域对象"""
        ...
...
#     """OrderItem 映射器实现 - 使用框架 AutoMapper
#
#     框架自动推断字段映射：
#     - 同名字段自动映射

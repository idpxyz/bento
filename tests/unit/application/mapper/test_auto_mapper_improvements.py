...
from bento.application.mapper.auto import AutoMapper
...
def test_field_matching_priority_picks_user_id_over_user() -> None:
    ...
    # 'user' remains default (empty string) because dataclass requires value; our map sets only matched fields
    assert po.user == ""

...
@pytest.mark.asyncio
async def test_uow_commit_immediate_publish_success_path():
    ...
    try:
        ...
        async with async_session() as session:
            ...
            # Monkeypatch retrying publisher to a no-op to cover success branch
            async def _no_retry(events):
                return None

            uow._publish_with_retry = _no_retry  # type: ignore[assignment]
